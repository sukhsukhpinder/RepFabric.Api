...
public class Function
{
    ...
    public Function()
    {
        ...
        _excelTemplateService = services.BuildServiceProvider().GetRequiredService<IExcelTemplateService>();
    }
    ...
    {
        var fileBytes = await _excelTemplateService.FillTemplateAsync(request.PathParameters["orderId"], int.Parse(request.PathParameters["mappingId"]));
